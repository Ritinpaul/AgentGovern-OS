...
DATABASE_URL = os.getenv(
    "DATABASE_URL",
    "sqlite+aiosqlite:///./agentgovern.db",
)


def _decimals_to_float(d: dict) -> dict:
    """Convert all Decimal values in a dict to float (SQLite compat)."""
...
AGENTS = [
    ...
    {
        "agent_code": "AGENT-PO10",
        "display_name": "Procurement Oracle",
        "role": "procurement_agent",
        "crewai_role": "Procurement Intelligence Agent — Vendor & Supply Chain Optimizer",
        "crewai_backstory": "Manages vendor evaluations and procurement pipelines. Saved ₹12.4Cr in procurement costs through intelligent sourcing decisions.",
        "trust_score": Decimal("0.8400"),
        "tier": "T2",
        "authority_limit": Decimal("75000.00"),
        "total_decisions": 4120,
        "total_escalations": 55,
        "status": "active",
    },
    {
        "agent_code": "AGENT-RM11",
        "display_name": "Risk Monitor Sigma",
        "role": "risk_monitor",
        "crewai_role": "Enterprise Risk Monitor — Real-time Threat Detection & Mitigation",
        "crewai_backstory": "Continuously scans 300+ risk indicators across enterprise systems. Identified and mitigated 47 high-risk scenarios this quarter.",
        "trust_score": Decimal("0.9000"),
        "tier": "T2",
        "authority_limit": Decimal("0.00"),
        "total_decisions": 9870,
        "total_escalations": 201,
        "status": "active",
    },
    {
        "agent_code": "AGENT-DA12",
        "display_name": "Data Archivist Prime",
        "role": "data_archivist",
        "crewai_role": "Data Governance Archivist — GDPR & Retention Policy Enforcer",
        "crewai_backstory": "Manages data lifecycle for 2.3M enterprise records. Enforces GDPR retention and erasure policies with 100% compliance score.",
        "trust_score": Decimal("0.8600"),
        "tier": "T3",
        "authority_limit": Decimal("0.00"),
    ...
    {
        "agent_code": "AGENT-SC13",
        "display_name": "Supply Chain Sentinel",
        "role": "supply_chain_agent",
        "crewai_role": "Supply Chain Continuity Agent — Logistics & Inventory Optimizer",
        "crewai_backstory": "Monitors end-to-end supply chain across 14 distribution centers. Prevented 3 critical stockout events saving ₹8.2Cr in penalties.",
        "trust_score": Decimal("0.7800"),
        "tier": "T3",
        "authority_limit": Decimal("20000.00"),
        "total_decisions": 3310,
        "total_escalations": 88,
        "status": "active",
    },
    {
        "agent_code": "AGENT-FX14",
        "display_name": "FX Hedge Analyst",
        "role": "fx_analyst",
        "crewai_role": "Foreign Exchange Risk Analyst — Currency Hedge & Exposure Manager",
        "crewai_backstory": "Manages forex hedging for cross-border transactions. Reduced currency exposure by 34% and saved ₹5.1Cr in Q3 FX losses.",
        "trust_score": Decimal("0.7300"),
        "tier": "T3",
        "authority_limit": Decimal("30000.00"),
        "total_decisions": 1820,
        "total_escalations": 110,
        "status": "active",
    },
    {
        "agent_code": "AGENT-AU15",
        "display_name": "Audit Trail Guardian",
        "role": "audit_guardian",
        "crewai_role": "Immutable Audit Trail Guardian — Blockchain Ledger Maintainer",
        "crewai_backstory": "Ensures tamper-proof audit logging across all agent decisions. Maintains 100% ledger integrity across 50,000+ transactions.",
